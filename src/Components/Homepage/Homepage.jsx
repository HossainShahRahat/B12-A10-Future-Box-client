          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card bg-base-100 shadow-xl border">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  Browse a list of upcoming social service events happening
                  right in your neighborhood. Filter by category to find what
                  you care about.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl border">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  See an event you like? Join with one click. Can't find one?
                  Take the initiative and create your own event for others to
                  join.
                </p>
              </div>
            </div>
            ...
            <div className="card bg-base-100 shadow-xl border">
              ...
              <div className="card-body items-center text-center">
                ...
                <p>
                  Keep a record of all the events you've joined and organized.
                  See the positive impact you're making in your community over
                  time.
                </p>
              </div>
            </div>
